...
def ipinfo():
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|        Coded By Mr.Robot           |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|          Thank You                 |")
       slowprint("\033[1;36m =====================================")
       print (" ")
...
def about():
       os.system("figlet Mr.Robot | lolcat")
       time.sleep(1)
       os.system("clear")
       print ("\033[1;32m\007\n")
       os.system("figlet IP-Info | lolcat")
       time.sleep(2)
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;33m" + "         [+] Tool Name     =>\033[1;36m" + " IP-Information")
       slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " Mr.Robot")
       slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 3/4/2023")
       slowprint ("\033[1;33m" + "         [+] Telegram      =>\033[1;36m" + " Mr_Rorbot")
       slowprint ("\033[1;33m" + "         [+] Github        =>\033[1;36m" + " SecurityLeader")
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;95m" + "           [+]   F*ck Life  [+]            ")
       slowprint ("\033[1;91m -----------------------------------------------")
